...
extension HomeViewController: UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let titleLabelText = MenuSingleton.shared.sections[indexPath.section].rows[indexPath.row]
        let subTitleLabelText = MenuSingleton.shared.sections[indexPath.section].rows[indexPath.row].description
        let priceLabelText = MenuSingleton.shared.sections[indexPath.section].rows[indexPath.row].price
        let rowsInt: Int = MenuSingleton.shared.sections[indexPath.section].rows.count
        ...
        let vc: DetailsViewController = DetailsViewController(category: section.title ?? "", title: titleLabelText.title , description: subTitleLabelText.description , price: priceLabelText, rows: rowsInt, restOfData: restOfData)
